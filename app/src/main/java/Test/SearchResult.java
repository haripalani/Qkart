...
public class SearchResult {
    ...
    public String getTitleofResult() {
        ...
        WebElement element = parentElement.findElement(By.xpath("//div[@class='MuiCardContent-root css-1qw96cp']"));
     ...
     */
    public Boolean closeSizeChart(ChromeDriver driver) {
        try {
            synchronized (driver) {
                driver.wait(2000);
            }
     ...
     */
    public Boolean verifyExistenceofSizeDropdown(ChromeDriver driver) {
        Boolean status = false;
        try {
